...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.Player_1=raquette.Raquette(40,self.height//2,"Amirreza",arcade.color.RED)
        self.Player_2=raquette.Raquette(self.width-40,self.height//2,"Mamad",arcade.color.GREEN)
